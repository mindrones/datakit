...
[0, 0]
> getFirstAndLast([])
[undefined, undefined]`],filePath:`array/array/getFirstAndLast.ts`,lineNumber:16,name:`getFirstAndLast`,since:`0.1.0`},{description:`Return the range within the provided limits, both limits being included.`,examples:[`> inclusiveRange([2, 5])
[2, 3, 4, 5]
...
'b'
> getShorter([])
undefined`],filePath:`array/iterable/getShorter.ts`,lineNumber:20,name:`getShorter`,since:`0.1.0`}],id:`array/iterable`,inputType:`array`,label:`array → iterable`,outputType:`iterable`},{functions:[{description:`Return the average of the numbers in the provided array`,examples:[`> arrayAverage([1, 23, 6])
10
> arrayAverage([])
...
[1, 2, 3]`],filePath:`generic/generic/makeEmptyArrayIfUndefined.ts`,lineNumber:12,name:`makeEmptyArrayIfUndefined`,since:`0.1.0`},{description:"Return a copy of the input after stringifying and parsing it.\nUseful to strip `undefined` values for JSON comparison.",examples:[`> sanitize({a: 1, b: undefined})
{a: 1}
